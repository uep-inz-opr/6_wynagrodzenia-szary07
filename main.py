...
for y in range (liczba_pracownikow):
    ...
    print(imie, f"{pracownicy[y].__obliczanie_netto__():.2f}", f"{pracownicy[y].__obliczanie_netto__():.2f}", f"{pracownicy[y].__obliczanieskladki__():.2f}", f"{pracownicy[y].__koszt__():.2f}")
